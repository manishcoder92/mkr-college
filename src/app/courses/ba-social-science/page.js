...
const subjects = [
  'Ancient Indian History, Culture & Archaeology (AIH&C)',
  'Economics',
  'Geography',
  'History',
  'Home Science',
...
const semesters = [
  { sem: 1, title: 'Social Science Semester-1', subjects: ['Foundation of Social Sciences', 'Hindi / Urdu / Maithili (MIL)', 'English Communication', 'Environmental Studies', 'Elective I (Choose from: Economics / History / Political Science / Psychology / Sociology / Geography / Home Science / AIH&C)'] },
  { sem: 2, title: 'Social Science Semester-2', subjects: ['Indian Society & Culture', 'Hindi / Urdu / Maithili (MIL)', 'English Communication-II', 'Elective I (Advanced)', 'Elective II'] },
  { sem: 3, title: 'Social Science Semester-3', subjects: ['Research Methodology (Basics)', 'Elective I (Honours Paper)', 'Elective II (Honours Paper)', 'Skill Enhancement Course', 'Ability Enhancement Course'] },
  { sem: 4, title: 'Social Science Semester-4', subjects: ['Statistical Methods in Social Science', 'Elective I (Honours Paper)', 'Elective II (Honours Paper)', 'Skill Enhancement Course-II', 'Ability Enhancement Course-II'] },
  { sem: 5, title: 'Social Science Semester-5', subjects: ['Discipline Specific Elective (DSE-I)', 'Discipline Specific Elective (DSE-II)', 'Honours Core Paper', 'Generic Elective'] },
  { sem: 6, title: 'Social Science Semester-6', subjects: ['Discipline Specific Elective (DSE-III)', 'Discipline Specific Elective (DSE-IV)', 'Honours Core Paper', 'Project / Dissertation'] },
];

export default function BASocialSciencePage() {
  const { language } = useLanguage();

  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Banner */}
      <div className="relative bg-gradient-to-br from-[#800000] to-[#5C0000] text-white py-24 px-4">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1523050854058-8df90110c8f1?w=1200&q=80')] bg-cover bg-center opacity-20" />
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-bold mt-4">
            {language === 'en' ? "Bachelor's of Arts (BA)" : 'बैचलर ऑफ आर्ट्स (बीए)'}
          </h1>
          <p className="text-2xl text-[#FFD700] font-serif mt-2">Social Science</p>
          <p className="mt-4 max-w-3xl opacity-90 leading-relaxed">
            {language === 'en'
              ? 'A Bachelor of Arts (BA) in Social Science integrates disciplines such as Ancient Indian History Culture & Archaeology (AIH&C), Economics, Geography, History, Home Science, Political Science, Psychology, and Sociology, exploring human behavior and cultures.'
              : 'बैचलर ऑफ आर्ट्स (बीए) सामाजिक विज्ञान में प्राचीन भारतीय इतिहास संस्कृति एवं पुरातत्व (AIH&C), अर्थशास्त्र, भूगोल, इतिहास, गृह विज्ञान, राजनीति विज्ञान, मनोविज्ञान और समाजशास्त्र जैसे विषयों को एकीकृत करता है।'
            }
          </p>
